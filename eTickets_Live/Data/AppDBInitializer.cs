...
{
    // VT için kullanılabilecek test dataları yaratmak için
    ...
    public class AppDBInitializer
    {
        ...
        public static void Seed(IApplicationBuilder applicationBuilder) 
        {
            ...
            {
                var context = serviceScope.ServiceProvider.GetService<AppDbContext>(); // DBContextimin yapısını bir servis olarak yaratıyor.

                context.Database.EnsureCreated(); // VT varolup/olmadığına bakıyor. Yoksa yaratıyor.

                //Cinema
                if (!context.Cinemas.Any()) // herhangi bir kayıt var mı / yok mu
                {
                    ...
                    context.SaveChanges(); // veriyi kaydet VT tarafına
                }
